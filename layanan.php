    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <select class="form-select" aria-label="Default select example" onChange="document.location.href=this.options[this.selectedIndex].value;">
                <option selected>Select the form</option>
                <option value="layanan\k4.1.php">4.1 	Standar Layanan Administrasi Mahasiswa Dan Lulusan </a> </option>
